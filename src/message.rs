...
impl LocalUseSection {
    ...
    pub fn read<R: BufRead>(header: SectionHeader, _reader: &mut R) -> Result<LocalUseSection> {
...
impl DataRepresentationSection {
    ...
    pub fn read<R: BufRead>(
        ...
        reader: &mut R,
    ) -> Result<DataRepresentationSection> {
        header.ensure_section_number(5)?;
        let drs = DataRepresentationSection {
            section_length: header.section_length,
